  ...
  var player = {
    ...
    bindEvents: function bindEvents() {
      ...
      slowBtn.onclick = function () {
        return player.adjustSpeed(50);
      };

      normalBtn.onclick = function () {
        return player.adjustSpeed(20);
      };

      fastBtn.onclick = function () {
        return player.adjustSpeed(1);
      };
    },
    run: function run() {
    ...
    adjustSpeed: function adjustSpeed(time) {
...
//# sourceMappingURL=main.0f89c0c2.js.map